            ...
            <div className={`w-full flex flex-col md:flex-row items-center relative z-10 ${!user ? 'max-w-6xl justify-between gap-12 lg:gap-20' : 'h-full justify-end w-full'}`}>
                 {!user ? (
                     ...
                     <>
                         ...
                         <div className="w-full flex justify-end animate-[fadeInRight_0.6s_ease-out] relative z-10 lg:absolute lg:right-0 lg:top-1/2 lg:-translate-y-1/2 lg:w-auto lg:pr-8">
