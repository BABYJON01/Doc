...
const AIChatbot = () => {
    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
                ...
                <div className="bg-slate-900 border border-slate-700 rounded-2xl shadow-[0_0_40px_rgba(59,130,246,0.3)] w-[350px] max-w-[calc(100vw-3rem)] h-[500px] max-h-[70vh] flex flex-col overflow-hidden">
                    ...
                    <div className="bg-gradient-to-r from-blue-900 to-indigo-900 p-4 border-b border-blue-500/30 flex justify-between items-center">
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-full bg-blue-500/20 flex items-center justify-center border border-blue-400/50 overflow-hidden">
                                <img src="/medical-robot.png" alt="Medical Robot" className="w-full h-full object-cover" />
                            </div>
                            <div>
            ...
            >
                {isOpen ? <i className="fa-solid fa-xmark text-2xl"></i> : <img src="/medical-robot.png" alt="Bot" className="w-9 h-9 object-cover rounded-full" />}
                {!isOpen && (
