...
export const translations = {
  uz: {
    ...
    platformBadge: "Toshkent davlat tibbiyot universiteti — O'quv Bazasi",
  ...
  ru: {
    ...
    platformBadge: "Ташкентский государственный медицинский университет — Учебная база",
  ...
  en: {
    ...
    platformBadge: "Tashkent State Medical University — Learning Hub",
