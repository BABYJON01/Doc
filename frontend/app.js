...
const apiUrlBase = 'https://docassist-backend-production.up.railway.app/api';
    ...
    if(xrayUpload) {
        xrayUpload.addEventListener('change', async function(e) {
            ...
            try {
                ...
                // Always use relative /api/predict for Vercel, or full fallback if testing file locally
                const apiUrl = isLocal ? 'https://docassist-backend-production.up.railway.app/predict' : '/api/predict';
